create temporary table DAS_API_ResponseSummaryData2 using CarbonJDBC options (dataSource "WSO2AM_STATS_DB", tableName "NEW_ANALYTICS_TABLE",
  schema "api STRING,
  api_version STRING,
  apiPublisher STRING,
...
CREATE TEMPORARY TABLE APIMGT_PERMINUTE_RESPONSE_DATA USING CarbonAnalytics OPTIONS(tableName "ORG_WSO2_APIMGT_STATISTICS_PERMINUTERESPONSE", schema "
    ...
    incrementalParams "APIMGT_STATISTICS_HOURLY_RESPONSE, HOUR",
    mergeSchema "false");
    ...
    INCREMENTAL_TABLE_COMMIT APIMGT_STATISTICS_HOURLY_RESPONSE;
